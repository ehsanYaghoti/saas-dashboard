...
import { lineLabelsPlugin } from "@/plugins/doughnutChartPlugins";
...
export function DoughnutChart() {
  return <div className=" flex flex-col items-start w-full  " >
    ...
    <Doughnut data={doughnutChartData} options={doughnutChartOptions} plugins={[lineLabelsPlugin]}  className=" overflow-visible"  />
  </div>
}
