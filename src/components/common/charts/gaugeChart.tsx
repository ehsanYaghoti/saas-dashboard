  ...
  return (
    <div className="flex flex-col items-center [grid-area:e] w-auto min-h-72 bg-white dark:bg-dark-4 rounded-lg border border-slate-200 shadow-md relative">
      ...
      <div className=" flex items-center w-full px-12 divide-x-2 divide-[#E5E9EF] ">
        ...
        "
        >
          <span className=" text-xl font-bold text-slate-800 dark:text-dark-text">1,809</span>
          <p className=" text-base font-bold text-slate-400 dark:text-dark-text">Premium Plan</p>
        </div>
        <div
        ...
        "
        >
          <span className=" text-xl font-bold text-slate-800 dark:text-dark-text">515</span>
          <p className=" text-base font-bold text-slate-400 dark:text-dark-text">Basic Plan</p>
        </div>
      </div>
