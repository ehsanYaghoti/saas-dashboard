      ...
      <Sidebar collapsible="icon" className="font-inter bg-white ">
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              ...
              >
                ...
                <h1
                  className={`font-bold text-2xl text-primary-4 ${
        ...
        <SidebarFooter className=" px-4">
          <SidebarMenu>
            <SidebarMenuItem>
              {/* <SidebarMenuButton> */}
              <SidebarMenuButton className="group-data-[collapsible=icon]:hidden focus:!bg-primary-1 hover:bg-primary-1 w-full h-[160px] p-4 rounded-md bg-primary-1
